...
import {validateDates,  validateOJTDates , validateBatchDescription,validateStartDate, roleBasedReadonly} from './../util/validation';
...
import {isNotEmpty} from './../util/validation';
  ...
  constructor(props) {
    ...
    {
      this.state = {traingHrs:0,Ojt:0,courseData:[],user:[],errors : {courseId:'',batchType:'',batchDescription:'',batchOwner:'',ydmCoach:'',startDate:'',endDate:'',ojtStartDate:''},batchData : props.location.state.batch 
    };
   // alert("get data"+JSON.stringify(this.state.batchData));
    ...
    {
      this.state ={traingHrs:0,Ojt:0,courseData:[], user:[],errors : {courseId:'',batchType:'',batchDescription:'',batchOwner:'',ydmCoach:'',startDate:'',endDate:'',ojtStartDate:''},batchData : {courseId:'',batchType:'',batchDescription:'',batchOwner:'',ydmCoach:'',startDate:'',endDate:'',ojtStartDate:'',createdBy : UserContext.userid, dbUserId:UserContext.dbUserId
      }};
