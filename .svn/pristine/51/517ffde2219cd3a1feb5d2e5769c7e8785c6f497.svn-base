        ...
        <Tabs value={value} onChange={handleChange} aria-label="simple tabs example" variant="scrollable"
          ...
          //  hidden = {UserContext.roleName != 'Principal' ? false : true } 
           />
            ...
            <Tab label="Existing Business" {...a11yProps(7)}/>
            <Tab label="Business Case Brief" {...a11yProps(8)}  
          //   hidden = { props.location.state.status != 'Mobilised' 
          //  ? true : false }
          />
          <Tab label="Recommend" {...a11yProps(9) }   />
          <Tab label="Assessor Evaluation" {...a11yProps(10)} hidden = {UserContext.centerName == 'Nano Unicorn' && props.location.state.status == 'Mobilised' ? false : true } />
          <Tab label="Enrollment" {...a11yProps(11)} hidden = {(UserContext.roleName == 'Center Manager' && (props.location.state.status == 'Shortlisted' || props.location.state.status == 'Enrolled')) || (UserContext.roleName == 'Change leader/Facilitator' && props.location.state.status == 'Enrolled') ?  false: true } />
      ...
      <AppBar position="static">
        <Tabs value={value} onChange={handleChange} aria-label="simple tabs example" variant="scrollable"
          ...
          //  hidden = {UserContext.roleName == 'Center Manager'  ? true : false } 
           ...
           />
          <Tab label="Recommend" {...a11yProps(9) }  hidden = {UserContext.roleid == 4  ? false : true } />
          <Tab label="Assessor Evaluation" {...a11yProps(10)} hidden = {UserContext.centerName == 'Nano Unicorn' ? false : true } />
          <Tab label="Enrollment" {...a11yProps(11)} hidden = {UserContext.roleName != 'Principal'  ?  false: true } />
