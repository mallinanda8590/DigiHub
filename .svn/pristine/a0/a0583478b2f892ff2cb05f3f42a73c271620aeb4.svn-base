...
import {updateCourseDetails} from './../../util/api.js'
...
class CreateCourse extends Component {
    ...
    constructor(props) {
        super(props);   
        this.state = {courseDetails:{name:'',description:'',fee:'',trainingHour:'',
                      studentPerBatch:'',ojt:'',isActive:'Y',
                      createdBy:UserContext.userid,updatedBy:UserContext.userid},
            errors: {name:'',description: '',fee:'',trainingHour: '',studentPerBatch:'',ojt:''}};
        }
            ...
            <Grid item xs={12}>
                ...
                <Grid item xs={12} sm={12}>
                  <FormControl>
                    ...
                    error={this.state.errors.name==''?false:true}
