...
class Counselling extends Component
{
    constructor(props) {
       ...
       //alert(props.history);
        ...
        this.state = {reason:'',beneficiaryStatus:'',res : {},code :'' ,history : props.history , result : localStorage.getItem("result"), dbUserId : props.id,name:'',basicData : {createdBy : UserContext.userid,
