...
import { fetchCentersOfUser, fetchCentersDetails, fetchRoleDetails,setDefaultSettings} from './../util/api';
...
export default class Settings extends Component {
  ...
  saveDefaultSettings = (event) => {
    ...
    setDefaultSettings(UserContext.userid,this.state.roleId,this.state.centerId).then((jsondata) => {
