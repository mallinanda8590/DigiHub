...
//.then((jsondata) => {
  ...
  // formData.append('data', '{"token" : "", "action" : "captureDocDetails", "data" : [{"dbUserId":'+this.state.dbUserId+',"engagementId":'+this.state.engagementId+',"documentType":"'+documentType+'","typeOfDocument":"'+levelOfDocument+'","documentName":"'+this.state.typeOfDocument+'","documentNo":"'+this.state.documentNumber+'"}]}');
...
<Table  aria-label="simple table" style={{ width:"100%"}}>
        <TableHead>
          <TableRow>
            ...
            <TableCell style={{ width:"20%"}}>Document Number</TableCell>
...
<br/>
      ...
      <Grid container direction="row" justify="flex-end" alignItems="flex-end">
             <Button type="submit" variant="contained" color="primary" size="small" 
                    disabled={this.state.file==null || this.state.typeOfDocument=='' || this.state.documentType=='' || this.state.documentNumber==''?true:false}
