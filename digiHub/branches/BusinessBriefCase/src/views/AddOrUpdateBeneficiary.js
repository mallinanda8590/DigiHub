      ...
      <AppBar position="static">
        <Tabs value={value} onChange={handleChange} aria-label="simple tabs example" variant="scrollable"
          ...
          //  hidden = {UserContext.roleName != 'Principal' ? false : true } 
           />
            <Tab label="Observation" {...a11yProps(6)}  hidden = {UserContext.roleName == 'Center Manager' || props.location.state.status != 'Mobilised' ? true : false }/>
            <Tab label="Business Case Brief" {...a11yProps(7)}  
          //   hidden = { props.location.state.status != 'Mobilised' 
          //  ? true : false }
          />
          <Tab label="Recommend" {...a11yProps(8) }  hidden = {UserContext.roleid == 4 && props.location.state.status == 'Mobilised' ? false : true } />
          <Tab label="Assessor Evaluation" {...a11yProps(9)} hidden = {UserContext.centerName == 'Nano Unicorn' && props.location.state.status == 'Mobilised' ? false : true } />
          <Tab label="Enrollment" {...a11yProps(10)} hidden = {(UserContext.roleName == 'Center Manager' && (props.location.state.status == 'Shortlisted' || props.location.state.status == 'Enrolled')) || (UserContext.roleName == 'Change leader/Facilitator' && props.location.state.status == 'Enrolled') ?  false: true } />
          <Tab label="Business Evaluation" {...a11yProps(11)} hidden = {UserContext.roleName == 'Principal' && props.location.state.status == 'Shortlisted'  ?  false: true } />
          <Tab label="Documents" {...a11yProps(12)}/>
        </Tabs>
      </AppBar>
      ...
      <AppBar position="static">
        <Tabs value={value} onChange={handleChange} aria-label="simple tabs example" variant="scrollable"
          ...
          <Tab label="Experience" {...a11yProps(4)} />
           ...
           <Tab label="Observation" {...a11yProps(6)}  hidden = {UserContext.roleName == 'Center Manager'  ? true : false }/>
           <Tab label="Business Case Brief" {...a11yProps(7)}  
          //  hidden = {UserContext.roleName == 'Center Manager'  ? true : false } 
           
           />
          <Tab label="Recommend" {...a11yProps(8) }  hidden = {UserContext.roleid == 4  ? false : true } />
          <Tab label="Assessor Evaluation" {...a11yProps(9)} hidden = {UserContext.centerName == 'Nano Unicorn' ? false : true } />
          <Tab label="Enrollment" {...a11yProps(10)} hidden = {UserContext.roleName != 'Principal'  ?  false: true } />
          <Tab label="Business Evaluation" {...a11yProps(11)} hidden = {UserContext.roleName == 'Principal'  ?  false: true } />
          <Tab label="Documents" {...a11yProps(12)}/>
        </Tabs>
      </AppBar>
      <TabPanel value={value} index={0}>
