...
class MyBatches extends Component {
  constructor(props) {
    super(props);
    this.state = {studentDetails:[],selectedStudentId:'',engagementId : props.engagementId,linkedEngagementId: props.linkedEngagementId,selectedEngagementId:'',selectedBatchDetails:[],selectedBeneficiaryName:''};  
